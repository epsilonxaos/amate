...
/*!****************************************!*\
  !*** ./resources/js/pages/validate.js ***!
  \****************************************/
/*! exports provided: validateAnyForm */
...
$(function () {
  alertifyjs_build_alertify_min__WEBPACK_IMPORTED_MODULE_0___default.a.success('Ready!');
});
...
function validateAnyForm(_idForm) {
  ...
  $('#' + _idForm).find('.radio-validate').each(function () {
    var b = $(this).find(':radio:checked').val();

    if (b === undefined) {
      _valid = false;
      $(this).find(':radio +label').each(function () {
  ...
  if (!_valid) {
    if (_notify == 'true') notification("validate", "general", "error");
  }
...
/***/ 10:
/*!**********************************************!*\
  !*** multi ./resources/js/pages/validate.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/murmurante/resources/js/pages/validate.js */"./resources/js/pages/validate.js");
