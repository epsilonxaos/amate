                ...
                <div class="row justify-content-center">
                   ...
                   {{-- <input type="hidden" name="boletos" id="boletos" value="{{count($asientos)}}">--}}
                    <div class="col-lg-7 col-md-8 col-sm-12">
                            ...
                            @foreach($precios as $i => $precio)
                                <div class="col-12 col-sm-4 col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <input class="custom-radio radio-validate" {{$i == 0 ? 'checked' : ''}} type="radio" id="precio_id_{{$precio -> id}}" name="precio_id" value="{{$precio->id}}" data-precio="{{$precio -> precio_final}}">
                                        <label class="text-center" for="precio_id_{{$precio -> id}}">
                                            <span></span> <br> <b class="text-white">{{$precio -> concepto}} - ${{number_format($precio->precio_final, 2)}} MXN</b>
                                        </label>
                        ...
                        <label for="boletos" class="text-white">Cantidad de boletos</label>
                        <input type="number" class="form-control m15" aria-valuemin="1" name="boletos" id="boletos" required value="0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    Número de boletos: <span id="no_boletos">0</span>  <br>
                        ...
                        <div class="row content-cupon">
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                ...
                                <input type="hidden" name="precio_boleto" value="0">
                            </div>
