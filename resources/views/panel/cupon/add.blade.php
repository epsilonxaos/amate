        ...
        <div class="row">
            <div class="col">
                <div class="card">
                    ...
                    <!-- Light table -->
                    <div class="card-body">
                        <form action="{{ route('panel.cupon.store') }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                            {{ csrf_field() }}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group @error('fecha_inicio') invalid @enderror">
                                                            ...
                                                            <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control" autocomplete="off" value="{{ old('fecha_inicio') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group @error('fecha_termino') invalid @enderror">
                                                            ...
                                                            <input type="date" name="fecha_termino" id="fecha_termino" class="form-control" autocomplete="off" value="{{ old('fecha_termino') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group @error('fecha_termino') invalid @enderror">
                                                            ...
                                                            <select name="tipo" id="tipo" class="form-control" required>
                                                                <option {{ old('tipo') == 1 ? 'selected' : '' }} value="1">Efectivo</option>
                                                                <option {{ old('tipo') == 2 ? 'selected' : '' }} value="2">Porcentaje</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group @error('descuento') invalid @enderror">
                                                            ...
                                                            <input type="text" name="descuento" id="descuento" class="form-control" autocomplete="off" value="{{ old('descuento') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="form-group @error('limite') invalid @enderror">
                                                            <label class="form-control-label" for="limite">Limite Uso</label>
                                                            <input type="text" name="limite" id="limite" class="form-control" autocomplete="off" value="{{ old('limite') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
